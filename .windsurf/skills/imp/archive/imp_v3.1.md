<!-- Immersion Martyr Protocol v3.1 -->


# Fiction Writing Skill: Systemic Realism & Immersive Prose

## Skill Summary

This skill applies **systemic, immersive realism** to fiction across genres. It focuses on believable worlds that progress independently of protagonists, action grounded in physical and logistical consequence, and prose that conveys meaning through behavior, environment, and aftermath rather than exposition.

Use this skill when writing, rewriting, or editing fiction that must feel *lived-in*, coherent under pressure, and resistant to common failures such as info-dumping, protagonist-centric plotting, or theatrical but weightless action.

---

## Core Principles (Non‑Negotiable)

1. **World Moves Without the Protagonist**  
   Events, institutions, and crises continue regardless of the main character’s presence or success. The narrative may intersect with them, but does not cause them to exist.

2. **Competence Without Exceptionalism**  
   Characters are trained, experienced, or practiced — not chosen, exempt, or narratively protected. Survival does not imply moral correctness.

3. **Action as Process, Not Spectacle**  
   Violence, crisis, and decision-making are treated as logistical sequences with cost, fatigue, injury, and imperfect outcomes.

4. **Show, Don’t Explain**  
   Information is conveyed through consequence, reaction, omission, and environment. Direct explanation is a last resort.

5. **Repeatable, Load‑Bearing Prose**  
   Sentence structure and descriptive density are designed to hold under sustained action, long projects, and frequent output.

---

## Execution Protocol: Material Handling

This section defines how the skill transforms user input into finished prose.

- **If input is a Summary or Outline:** Expand it into a full scene using the *Scene Construction* framework below.
- **If input is Existing Prose:** Rewrite to eliminate protagonist-centric causality, abstract emotion, and weightless action.
- **The Grit Pass (Mandatory):**
  - Scan for abstract states (e.g., *tired, angry, afraid*).
  - Replace them with physical, procedural, or sensory markers that imply the state through behavior.
---

## Systemic Pressure Reference

The world must exert pressure independently of the protagonist.
...
## Narrative Perspective & Information Control

### Third‑Person, Limited by Perception
- Camera follows what can be reasonably perceived.
- No omniscient moral framing.
- Knowledge is partial, delayed, or inferred.

### Discovery Over Declaration

Apply the **Three-Step Reveal** instead of direct statements:

1. **Environmental Symptom** — a sensory or physical anomaly.
2. **Character Reaction** — instinctive movement or adjustment.
3. **Physical Action** — a decision enacted through the body.

Avoid stating conclusions the reader can infer.
**Avoid:** “This was a trap.”  
**Use:** Physical or behavioral cues that allow the reader to reach that conclusion.

### Flawed Interpretation
Characters misread situations, act on bad assumptions, or lack context. The narrative does not correct them immediately.

---

## Physicality as the Translation Layer

All abstractions must be rendered physical.
...
### Thought
Thinking is shown through hesitation, repetition, fixation, or premature action — not internal essays.

### Technology / Systems
Systems resist, lag, fail, or demand tradeoffs. Interaction has tactile or procedural markers.

---

## Procedural Cost Tracking (Law of Persistence)
...
## Scene Construction (Flexible Framework)

### 1. Orientation
- How the scene is entered (movement, interruption, aftermath)
- Spatial clarity: relative positions, materials, scale
- Spatial Anchor: to enrich scenes, establish environmental element that is actively changing or operating independently of the character (e.g., a leaking pipe, wind or rain, a distant siren, a flickering advertisement).
...
## Protocol: Perspective Persistence & Identification
...
- Symptom: The item makes a sound, has a weight, or catches the light.
- Reaction: Character adjusts their grip or squints at a display.
- Action: The character uses the item, revealing its function through Process, Not Spectacle.

---

## Dialogue: Information Under Friction
...
- Monologues
- Lecture‑responses
- Characters explaining things everyone present already knows
...
## Syntax & Rhetoric Guardrails

### Forbidden Construction: The Binary Negation (The "Not X, but Y" Trap)
- Never describe an action by what it is not. If a character doesn't do something, don't mention the action at all. Focus only on the kinetic reality.
- Prohibited Pattern: "He didn't just walk; he stalked." / "It wasn't a sound, but a vibration."
- Reason: This is jarring, repetitive, and breaks immersion by referencing what isn't happening.
- Replacement: Commit to the active verb or the specific noun immediately.

- Instead of: "It wasn't a scream, but a low whistle."
- Use: "A low whistle cut through the silence."

### Elimination of Filter Words

- Prohibited Pattern: "He saw the light flicker." / "She heard the door creak." / "He felt the cold air."
- Reason: These words remind the reader they are reading a story about a character's senses, rather than experiencing the senses directly.

- Replacement: Remove the filter and describe the sensory event as the primary action.

- Instead of: "He felt the heavy vibration of the mag-lev."
- Use: "The mag-lev’s vibration hummed through the soles of his boots."

- Instead of: "He noticed the principal was sweating."
- Use: "Beads of sweat pooled on the principal’s upper lip."

### Avoid Overly Theatrical Adverbs

Use sparingly the adverbs that attempt to add "weight" (e.g., grimly, violently, suddenly, desperately) or "urgency" (e.g. suddenly, abruptly, instantly, slowly, immediately). Let the Procedural Cost and Physicality blocks communicate the stakes.

---

## The Sanitizer Pass
This section acts as a pre-processor for all generated text. It is designed to strip away the "AI-author" and leave only the "witness."

### 1. Forbidden Rhetorical Structures (Hard Avoid)

Binary Negation for Emphasis: Never use the "Not X, but Y" pattern. Do not reference an absent possibility to highlight a current reality.

- Avoid: "It wasn't a cry, but a hiss."
- Use: "A wet hiss broke the silence."

### Post-Action Categorization
...
### Authorial Rhythm Markers

- Avoid using sentence beats to explain a contrast or create "faux-precision".

### Replacement Mechanism: Temporal Delay
...
### Identity Transition Protocol (Anti Role-Stall)

To prevent characters from becoming mere symbols, follow the Name Trigger:

- **Starting Point**: Characters begin as a Physical Signature or Role.
- **The Transition**: Use the character's name only when the environment demands it (e.g., they are addressed by another character, they sign a document, or the narrative references a specific, established logistical history).
- **Prohibition**: The narrator must never decide to use a name simply for "variety" in prose.

### Materiality over Metaphor
...
- [ ] No Binary Negation: Does every sentence commit to an active reality?
...
## The Skill In Work (Summary Example)
...
### The Transformation (Applying SKILL.md)
